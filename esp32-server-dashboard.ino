...
void setup()
{
    ...
    DASHBOARD_ITEM_TYPE dashboardItems2[DASHBOARD_ITEM_COUNT] = {DASHBOARD_ITEM_TYPE_CPU_TEMPERATURE, DASHBOARD_ITEM_TYPE_CPU_LOAD, DASHBOARD_ITEM_TYPE_MEM_USED, DASHBOARD_ITEM_TYPE_NETWORK_INTERFACE_DOWNLOAD_DYNAMIC_BANDWIDTH, DASHBOARD_ITEM_TYPE_NETWORK_INTERFACE_UPLOAD_DYNAMIC_BANDWIDTH};
