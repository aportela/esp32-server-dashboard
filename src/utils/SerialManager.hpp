...
enum SerialCommandType
{
    ...
    SERIAL_CMDT_SET_TOTAL_MEMORY_BYTES = 12,
    SERIAL_CMDT_SET_MIN_CPU_TEMPERATURE = 13,
    SERIAL_CMDT_SET_MAX_CPU_TEMPERATURE = 14,
    SERIAL_CMDT_SET_MAX_DOWNLOAD_BYTES_BANDWIDTH = 15,
    SERIAL_CMDT_SET_MAX_UPLOAD_BYTES_BANDWIDTH = 16,
    SERIAL_CMDT_SET_NETWORK_INTERFACE_ID = 17,
    SERIAL_CMDT_SET_NETWORK_INTERFACE_NAME = 18,
};
