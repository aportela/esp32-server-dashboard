...
LGFXScreenCPUDetails::LGFXScreenCPUDetails(LovyanGFX *display, SourceData *sourceData) : LGFXScreen(display)
{
    if (sourceData != nullptr)
    {
        ...
        if (display != nullptr)
        {
            ...
            FPS::Init();
#endif // DEBUG_FPS
            this->cpuLoadBlock1 = new LGFXScreenDashboardResumeEntityCPU(display, sourceData, METER_GRAPH_WIDTH, METER_GRAPH_HEIGHT, 0, (METER_GRAPH_HEIGHT + 11) * 0, DASHBOARD_ITEM_TYPE_CPU_LOAD);
            this->cpuLoadBlock2 = new LGFXScreenDashboardResumeEntityCPU(display, sourceData, METER_GRAPH_WIDTH, METER_GRAPH_HEIGHT, 0, (METER_GRAPH_HEIGHT + 11) * 1, DASHBOARD_ITEM_TYPE_CPU_SYSTEM);
            this->cpuLoadBlock3 = new LGFXScreenDashboardResumeEntityCPU(display, sourceData, METER_GRAPH_WIDTH, METER_GRAPH_HEIGHT, 0, (METER_GRAPH_HEIGHT + 11) * 2, DASHBOARD_ITEM_TYPE_CPU_USER);
            this->cpuLoadBlock4 = new LGFXScreenDashboardResumeEntityCPU(display, sourceData, METER_GRAPH_WIDTH, METER_GRAPH_HEIGHT, 0, (METER_GRAPH_HEIGHT + 11) * 3, DASHBOARD_ITEM_TYPE_CPU_IOWAIT);
            this->cpuLoadBlock5 = new LGFXScreenDashboardResumeEntityCPU(display, sourceData, METER_GRAPH_WIDTH, METER_GRAPH_HEIGHT, 0, (METER_GRAPH_HEIGHT + 11) * 4, DASHBOARD_ITEM_TYPE_CPU_IDLE);
            this->Refresh(true);
        }
    }
}
